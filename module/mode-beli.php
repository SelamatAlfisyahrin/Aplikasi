...
function insert($data){
    ...
    $cekbrg = mysqli_query($koneksi,"SELECT * FROM tbl_beli_detail WHERE no_beli = '$no' AND kode_barang='$kode' ");
...
function delete($idbrg,$idbeli,$qty){
    ...
    $sqlDel = "DELETE FROM tbl_beli_detail WHERE kode_barang = '$idbrg' AND no_beli='$idbeli'";
