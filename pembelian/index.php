...
if($msg=='deleted'){
    ...
    $qty = $_GET['qty'];
    $tgl = $_GET['tgl'];
    delete($idbrg,$idbeli,$qty,$tgl);

    echo"<script>
    alert('Berhasil Melakukan Transaksi Pembelian..');
    document.location = 'pembelian/index.php'?tgl=$tgl;
</script>";
}
...
if(isset($_POST['addbrg'])){
    ...
    if(insert($_POST)){
        echo"<script>
            document.location = 'index-beli.php'?tgl=$tgl;
        </script>";
    }
}
        ...
        <div class="container-fluid">
            <form action="" method="POST">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-warning p-3">
                            <div class="form-group row mb-2">
                                <label for="nobeli" class="col-sm-2 col-form-label">No Nota</label>
                                <div class="col-sm-4">
                                    <input type="text" name="nobeli" class="form-control" id="nobeli" value="<?= $noBeli?>" readonly>
                                </div>
                            ...
                            <div class="form-group row mb-2">
                                <label for="kodeBrg" class="col-sm-2 col-form-label">
                                    SKU
                                </label>
                                <div class="col-sm-10">
                                    <select name="kodeBrg" id="kodeBrg" class="form-control">
                                        ...
                                        foreach($barang as $brg){
                                            ...
                                            <option value="?pilihbrg=<?= $brg['id_brg']?> <?= @$_GET['pilihbrg']== $brg['id_brg'] ? 'selected' : null ?>"><?= $brg['id_brg']."|".$brg['nama_barang']?></option>
                ...
                <div class="card pt-1 pb-2 px-3">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="hidden" value="<?= @$_GET['pilihbrg'] ? $selectBrg['id_brg'] : ''?>" name="kodeBrg">
                                <label for="namaBrg">Nama Barang</label>
                                <input type="text" name="namaBrg" class="form-control form-control-sm" id="namaBrg"
                                 value="<?= @$_GET['pilihbrg'] ? $selectBrg['nama_barang'] : ''?>" readonly required>
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                value="<?= @$_GET['pilihbrg'] ? $selectBrg['stock'] : ''?>" readonly required>
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                value="<?= @$_GET['pilihbrg'] ? $selectBrg['satuan'] : ''?>" readonly required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                value="<?= @$_GET['pilihbrg'] ? $selectBrg['harga_beli'] : ''?>" readonly required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                value="<?= @$_GET['pilihbrg'] ? 1 : ''?>" required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-sm btn-info btn-block" name="addbrg"><i class="fas fa-cart-plus fa-sm"></i>
                                    ...
                                    foreach($brgDetail as $detail){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="?idbrg=<?= $detail['kode_barang']?> & idbeli=<?= $detail['no_beli']?>&qty=<?= $detail['qty']?>&tgl=<?= $detail['tgl_beli']?>&msg=deleted" class="btn btn-sm btn-danger" title="hapus barang" onclick="return confirm('Anda Yakin akan Menghapus barang Ini ?')"><i class="fas fa-trash"></i></a>
                                            </td>
                    ...
                    <div class="col-lg-6 p-2">
                        ...
                        <div class="col-sm-9">
                            <select name="suplier" id="suplier" class="form-control form-control-sm">
                                ...
                                <?php
                                        $suplier = getData("SELECT * FROM tbl_supplier");
