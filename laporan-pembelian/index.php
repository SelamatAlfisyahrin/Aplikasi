            ...
            <table class="table table-hover text-nowrap" id="example">
                ...
                foreach($pembelian as $beli){
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="detail-pembelian.php?id=<?= $beli['no_beli']?>&tgl=<?= in_date($beli['tgl_beli'])?>" class="btn btn-sm btn-info" title="detail pembelian"> Detail</a>
                        </td>
                    </tr>
                    <?php
                }
