...
$id = $_GET['id'];
$tgl = $_GET['tgl'];
$pembelian = getData("SELECT * FROM tbl_jual_detail WHERE no_jual = '$id'");
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Penjualan Detail</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <table class="table table-hover text-nowrap">
                ...
                foreach($pembelian as $beli){
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= number_format($beli['harga_jual'],0,",",".") ?></td>
